        ...
        <React.Fragment>
          ...
          <div className={classNames(classes.main, classes.mainRaised)}>
            <Grid container spacing={3} >
                  <Typography variant="h3" component="h3" style={{paddingLeft: '3%', color: "white"}}>
                    Shopping Cart
                  </Typography>
                  <Slide direction="up" in={true}>
                  <Grid item md={12} sm={12} xs={12}style={{padding: "2% 10% 10% 10%"}}>
                    <Card className={classes.card} style={{padding: "4%"}}>
                    <TableContainer>
