...
// import { Button, Card, Grid, Typography, LinearProgress, CircularProgress } from '@mui/material';
...
//         return(
//           <Card className={styles.main} style={{backgroundColor: "transparent", border: "none"}}>
